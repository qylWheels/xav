...
struct SchedDebugReconRuleWarningInfo : public IRuleWarningInfo {
    SchedDebugReconRuleWarningInfo(Process process, std::string path)
    ...
    virtual std::shared_ptr<IRuleWarningInfo> clone() const override {
        return std::make_shared<SchedDebugReconRuleWarningInfo>(*this);
    }
...
class SchedDebugReconRule : public IRuleBasedDetectionListenerRule {
public:
    SchedDebugReconRule();
    ~SchedDebugReconRule();
    SchedDebugReconRule(const SchedDebugReconRule&) = delete;
    SchedDebugReconRule& operator=(const SchedDebugReconRule&) = delete;
    SchedDebugReconRule(SchedDebugReconRule&&) = delete;
    SchedDebugReconRule& operator=(SchedDebugReconRule&&) = delete;
