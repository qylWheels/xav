...
struct RcdModificationRuleWarningInfo : public IRuleWarningInfo {
    RcdModificationRuleWarningInfo(Process process, std::string path)
    ...
    virtual std::shared_ptr<IRuleWarningInfo> clone() const override {
        return std::make_shared<RcdModificationRuleWarningInfo>(*this);
    }
...
class RcdModificationRule : public IRuleBasedDetectionListenerRule {
public:
    RcdModificationRule();
    ~RcdModificationRule();
    RcdModificationRule(const RcdModificationRule&) = delete;
    RcdModificationRule& operator=(const RcdModificationRule&) = delete;
    RcdModificationRule(RcdModificationRule&&) = delete;
    RcdModificationRule& operator=(RcdModificationRule&&) = delete;
