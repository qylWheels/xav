...
struct SystemRequestKeyModRuleWarningInfo : public IRuleWarningInfo {
    SystemRequestKeyModRuleWarningInfo(Process process, std::string path)
    ...
    virtual std::shared_ptr<IRuleWarningInfo> clone() const override {
        return std::make_shared<SystemRequestKeyModRuleWarningInfo>(*this);
    }
...
class SystemRequestKeyModRule : public IRuleBasedDetectionListenerRule {
public:
    SystemRequestKeyModRule();
    ~SystemRequestKeyModRule();
    SystemRequestKeyModRule(const SystemRequestKeyModRule&) = delete;
    SystemRequestKeyModRule& operator=(const SystemRequestKeyModRule&) = delete;
    SystemRequestKeyModRule(SystemRequestKeyModRule&&) = delete;
    SystemRequestKeyModRule& operator=(SystemRequestKeyModRule&&) = delete;
