...
void SyscallEventProvider::handle_raw_event_wrapper(
    ...
    switch (raw_event_wrapper.raw_event.syscall_id) {
        ...
        case SYS_open: {
            OpenSyscallAdditionalData additional_data;
            if (raw_event_wrapper.raw_event.enter_captured &&
                raw_event_wrapper.additional_data.size() == 1) {
        ...
        case SYS_openat: {
            OpenatSyscallAdditionalData additional_data;
            if (raw_event_wrapper.raw_event.enter_captured &&
                raw_event_wrapper.additional_data.size() == 1) {
                additional_data.path =
                    std::string(raw_event_wrapper.additional_data[0].begin(),
        ...
        case SYS_creat: {
            CreatSyscallAdditionalData additional_data;
            if (raw_event_wrapper.raw_event.enter_captured &&
                raw_event_wrapper.additional_data.size() == 1) {
                additional_data.path =
                    std::string(raw_event_wrapper.additional_data[0].begin(),
        ...
        case SYS_unlink: {
            UnlinkSyscallAdditionalData additional_data;
            if (raw_event_wrapper.raw_event.enter_captured &&
                raw_event_wrapper.additional_data.size() == 1) {
                additional_data.path =
                    std::string(raw_event_wrapper.additional_data[0].begin(),
        ...
        case SYS_execve:
        case SYS_execveat: {
            ExecveSyscallAdditionalData additional_data;
            if (raw_event_wrapper.raw_event.enter_captured &&
                raw_event_wrapper.additional_data.size() == 1) {
                additional_data.path =
                    std::string(raw_event_wrapper.additional_data[0].begin(),
