...
constexpr Message::ParseTableT_ Message::InternalGenerateParseTable_(
    ...
    return ParseTableT_{
        ...
        {{
            ...
            {PROTOBUF_FIELD_OFFSET(Message, _impl_.data_.scan_status_),
...
inline constexpr Message::Impl_::Impl_(
    ...
    : data_{}, _cached_size_{0}, _oneof_case_{} {}
...
Message::PlacementNew_(const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
...
constexpr auto Message::InternalGenerateClassData_(
    ...
    return ::google::protobuf::internal::ClassDataFull{
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
            &Message::SharedDtor,
            ::google::protobuf::Message::GetClearImpl<Message>(),
        ...
        &::_pbi::kDescriptorMethods, &descriptor_table_msg_2eproto,
        nullptr,  // tracker
...
struct MessageGlobalsTypeInternal : ::_pbi::MessageGlobalsBase {
    constexpr MessageGlobalsTypeInternal()
        :
#ifndef PROTOBUF_MESSAGE_GLOBALS
          _default(::_pbi::ConstantInitialized{}, Message_class_data_.base())
#else   // !PROTOBUF_MESSAGE_GLOBALS
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PROTOBUF_MESSAGE_GLOBALS_CONST
        MessageGlobalsTypeInternal Message_globals_
...
static constexpr const ::_pb::EnumDescriptor* PROTOBUF_NONNULL*
    PROTOBUF_NULLABLE file_level_enum_descriptors_msg_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor* PROTOBUF_NONNULL*
    PROTOBUF_NULLABLE file_level_service_descriptors_msg_2eproto = nullptr;
const ::uint32_t
...
const char
    descriptor_table_protodef_msg_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
...
void Message::set_allocated_scan_status(
    ::scan_status::ScanStatus* PROTOBUF_NULLABLE scan_status) {
    ::google::protobuf::Arena* message_arena = GetArena();
    clear_data();
    if (scan_status) {
        ::google::protobuf::Arena* submessage_arena =
            reinterpret_cast<::google::protobuf::Message*>(scan_status)
                ->GetArena();
        if (message_arena != submessage_arena) {
            scan_status = ::google::protobuf::internal::GetOwnedMessage(
                message_arena, scan_status, submessage_arena);
        }
        set_has_scan_status();
...
PROTOBUF_NDEBUG_INLINE Message::Impl_::Impl_(
    ...
    const Impl_& from, [[maybe_unused]] const ::msg::Message& from_msg)
    : data_{}, _cached_size_{0}, _oneof_case_{from._oneof_case_[0]} {}
        ...
        case kScanStatus:
            _impl_.data_.scan_status_ =
                ::google::protobuf::Message::CopyConstruct(
                    arena, *from._impl_.data_.scan_status_);
            break;
    }
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::google::protobuf::
    internal::ClassDataFull Message_class_data_ =
...
#ifndef PROTOBUF_MESSAGE_GLOBALS
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const Message::ParseTableT_ Message::_table_ =
    ...
    if (this_.data_case() == kScanStatus) {
        target =
            ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
                2, *this_._impl_.data_.scan_status_,
                this_._impl_.data_.scan_status_->GetCachedSize(), target,
                stream);
    }
        ...
        case kScanStatus: {
            total_size +=
                1 + ::google::protobuf::internal::WireFormatLite::MessageSize(
                        *this_._impl_.data_.scan_status_);
            break;
        }
        case DATA_NOT_SET: {
            break;
...
void Message::MergeImpl(::google::protobuf::MessageLite& to_msg,
    ...
    if (const uint32_t oneof_from_case = from._impl_._oneof_case_[0]) {
        ...
        switch (oneof_from_case) {
            case kScanStatus: {
                if (oneof_needs_init) {
                    _this->_impl_.data_.scan_status_ =
                        ::google::protobuf::Message::CopyConstruct(
                            arena, *from._impl_.data_.scan_status_);
                } else {
                    _this->_impl_.data_.scan_status_->MergeFrom(
                        *from._impl_.data_.scan_status_);
                }
                break;
            }
            case DATA_NOT_SET:
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type _static_init2_
    [[maybe_unused]] = (::_pbi::AddDescriptors(&descriptor_table_msg_2eproto),
                        ::std::false_type{});
